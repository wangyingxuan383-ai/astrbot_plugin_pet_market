...
![Version](https://img.shields.io/badge/Version-v2.3.9-green)

---

## 📝 更新日志

- v2.3.9：修复数据恢复与自动保存竞态；优化金额/目标解析；当清算倍率为 0 时不再封顶利息；补齐公寓相关配置项；管理员需显式配置 admin_uins。
...
| 配置项 | 默认值 | 说明 |
|--------|--------|------|
| `admin_uins` | 空列表 | 管理员 QQ 号列表（为空则管理员指令不可用） |
...
| `pet_per_house` | 5 | 每套公寓可容纳宠物数量 |
| `house_price` | 20000 | 购买公寓价格 |
| `house_rent_price` | 2000 | 租房价格 |
